...
use CrimsonAgility\ProductsRange\Model\Validators\HighPriceGreaterThanLowPrice;
...
class HighPriceGreaterThanLowPriceTest extends TestCase
{
    ...
    /**
     * @var HighPriceGreaterThanLowPrice $instance;
     */
    private HighPriceGreaterThanLowPrice $instance;
    ...
    {
        $this->instance = new HighPriceGreaterThanLowPrice(
    ...
    {
        $params = ['high_price' => 50, 'low_price' => 50.55];
